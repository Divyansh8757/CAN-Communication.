...
int main(void)
{
  ...
  sFilterConfig.FilterID1 = 0xC01FFA0;
  sFilterConfig.FilterID2 = 0xC01FFA3;
...
void HAL_FDCAN_RxFifo0Callback(FDCAN_HandleTypeDef *hfdcan, uint32_t RxFifo0ITs)
{
	  if((RxFifo0ITs & FDCAN_IT_RX_FIFO0_NEW_MESSAGE) != RESET)
	  {
		  ...
		  if(RxHeader.Identifier==0xC01FFA1){
			  count++;
			  MX_TIM2_Init();
			  MX_TIM3_Init();
			  MX_TIM7_Init();
		  ...
		  else if(RxHeader.Identifier==0xC01FFA2){
			  count=0;
			  TIM2->CCR1=0;
			  TIM3->CCR1=0;
			  memset(display, 0, sizeof(display));
		  ...
		  else if(RxHeader.Identifier==0xC01FFA0){
			  TIM2->CCR1=RxData[0];
			  TIM3->CCR1=RxData[1];
		  }
		  HAL_FDCAN_ActivateNotification(hfdcan, FDCAN_IT_RX_FIFO0_NEW_MESSAGE, 0);
